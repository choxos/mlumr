...
- survival_unit:
  ...
  For survival fits, the WAIC pointwise unit: `"observation"` (default),
  `"arm"`, or `"aggregate"` (see
  [`calculate_loo()`](https://choxos.github.io/mlumr/reference/calculate_loo.md)
...
[`calculate_loo()`](https://choxos.github.io/mlumr/reference/calculate_loo.md)).
For **survival** fits the AgD pointwise unit is a reconstructed
pseudo-individual, so WAIC is at the pseudo-individual level (see the
survival note on
[`calculate_loo()`](https://choxos.github.io/mlumr/reference/calculate_loo.md)).
