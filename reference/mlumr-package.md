...
4.  [`add_integration()`](https://choxos.github.io/mlumr/reference/add_integration.md)
    — build the Gaussian-copula QMC integration points used to
    marginalize over the AgD covariate distribution.
...
9.  [`prior_sensitivity()`](https://choxos.github.io/mlumr/reference/prior_sensitivity.md)
    — verify the posterior is data-driven rather than prior-driven.
...
[`stc()`](https://choxos.github.io/mlumr/reference/stc.md) runs
frequentist parametric G-computation (Simulated Treatment Comparison).
[`naive()`](https://choxos.github.io/mlumr/reference/naive.md) computes
an unadjusted crude-rate benchmark. Both consume the same `mlumr_data`
object as [`mlumr()`](https://choxos.github.io/mlumr/reference/mlumr.md)
so their estimands can be compared directly.
