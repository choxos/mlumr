...
changed between those two rows: the comparator coefficients are
identified by a single aggregate row, and the index-population estimand
extrapolates them across the IPD covariate distribution. A reader shown
