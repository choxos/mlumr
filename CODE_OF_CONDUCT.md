...
`mlumr` project a harassment-free experience for everyone, regardless of
...
- Sexualized language, imagery, attention, or advances in project
  spaces.
...
acceptable behavior. They may remove, edit, or reject comments, commits,
code, issues, pull requests, and other contributions that are not
aligned with this Code of Conduct.

Maintainers may also temporarily or permanently ban contributors for
...
issues, pull requests, discussions, documentation, and other project
communication channels. It also applies when an individual is officially
representing the project in public spaces.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the maintainers at `a.sofimahmudi@gmail.com`.
...
reporter and any affected parties.
