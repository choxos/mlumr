...
#> Marginals -- max relative difference: 0.0311
...
#>       mu_index 16.34389 1.545135 13.39368 19.31310 0.9997904
#>  mu_comparator 23.74424 2.332873 19.16747 28.27795 1.0030206
#> 
#> Residual SD:
#>  variable     mean        sd     2.5%    97.5%     Rhat
#>     sigma 19.34459 0.8411229 17.73348 21.05787 1.001152
#> 
#> Regression Coefficients:
#>            variable        mean         sd        2.5%      97.5%     Rhat
#>           beta[age] -0.10576503 0.12236003 -0.34130194 0.12388864 1.001518
#>  beta[baseline_vas]  0.03386783 0.03226607 -0.03026071 0.09725718 1.000092
#> 
#> Marginal Treatment Effects:
#>   Mean Differences:
#>          variable      mean       sd      2.5%     97.5%
#>       delta_index -7.400347 2.825435 -12.92053 -1.837505
#>  delta_comparator -7.400347 2.825435 -12.92053 -1.837505
```
...
|:----------------|:------|:----------|---------:|--------:|---------:|---------:|---------:|
|delta_index      |MD     |Index      | -7.400347| 2.825435| -12.92053| -7.428384| -1.837505|
|delta_comparator |MD     |Comparator | -7.400347| 2.825435| -12.92053| -7.428384| -1.837505|
...
|:-------|:----------------|:------|:----------|---------:|--------:|---------:|---------:|---------:|
|SPFA    |delta_index      |MD     |Index      | -7.400347| 2.825435| -12.92053| -7.428384| -1.837505|
|SPFA    |delta_comparator |MD     |Comparator | -7.400347| 2.825435| -12.92053| -7.428384| -1.837505|
|Relaxed |delta_index      |MD     |Index      | -7.643671| 2.818685| -13.08139| -7.604011| -2.266296|
|Relaxed |delta_comparator |MD     |Comparator | -7.502274| 2.818892| -12.89207| -7.456934| -2.136406|
...
|:---------|:----------|--------:|--------:|--------:|--------:|--------:|
|ASD       |Index      | 16.22385| 1.542963| 13.30048| 16.22798| 19.21283|
|ET        |Index      | 23.62420| 2.343226| 19.00757| 23.63653| 28.16822|
|ASD       |Comparator | 16.45923| 1.556495| 13.43213| 16.48640| 19.46809|
|ET        |Comparator | 23.85958| 2.329072| 19.32080| 23.86524| 28.36050|
...
|-------:|:------|---------:|--------:|---------:|---------:|---------:|
|       1|MD     | -7.400347| 2.825435| -12.92053| -7.428384| -1.837506|
|       2|MD     | -7.400347| 2.825435| -12.92053| -7.428384| -1.837506|
|       3|MD     | -7.400347| 2.825435| -12.92053| -7.428384| -1.837506|
...
#>  Relaxed      -0.2     0.4    0.72 |elpd_diff| < 4 1 k_psis > 0.7
#> 
...
#>     SPFA 1368.44 17.16      0.00
#>  Relaxed 1368.61 16.53      0.17
#> 
