...
is Poisson and has no dispersion parameter. If the IPD shows clear
overdispersion (compare `var(dmft)` against `mean(dmft)`), report the intervals
as a lower bound on uncertainty and state the limitation. Prespecified
