...
<img src="figure/km-1.png" alt="plot of chunk km"  />
...
#>   Pseudo-individuals = 408, Events = 263 (across 1 arm(s))
#> 
...
#> Observed RMST (comp trt, comp pop):      33.6594
#> 
...
#> 
#> Chain 2 finished in 504.2 seconds.
#> Chain 4 finished in 505.2 seconds.
#> Chain 1 finished in 528.6 seconds.
#> Chain 3 finished in 549.7 seconds.
#> 
#> All 4 chains finished successfully.
#> Mean chain execution time: 521.9 seconds.
#> Total execution time: 549.9 seconds.
```
...
#> Running MCMC with 4 parallel chains...
#> 
#> Chain 3 finished in 601.8 seconds.
#> Chain 4 finished in 611.1 seconds.
#> Chain 2 finished in 628.3 seconds.
#> Chain 1 finished in 663.9 seconds.
#> 
#> All 4 chains finished successfully.
#> Mean chain execution time: 626.3 seconds.
#> Total execution time: 664.0 seconds.
```
...
#> Running MCMC with 4 parallel chains...
#> 
#> Chain 4 finished in 494.8 seconds.
#> Chain 1 finished in 536.1 seconds.
#> Chain 2 finished in 546.6 seconds.
#> Chain 3 finished in 552.8 seconds.
#> 
#> All 4 chains finished successfully.
#> Mean chain execution time: 532.6 seconds.
#> Total execution time: 553.1 seconds.
```
...
#> 
#> Model: SPFA 
#> Family: Time-to-event (Survival) [mspline] 
#> Link: log 
#> Engine: cmdstanr 
...
#>       mu_index 0.31643388 0.11710251  0.08953652 0.5399132 1.000262
#>  mu_comparator 0.09155874 0.08476361 -0.07646226 0.2545366 1.000110
#> 
#> Regression Coefficients:
#>                variable       mean         sd       2.5%     97.5%     Rhat
#>               beta[age] 0.06978192 0.01619412  0.0391135 0.1024568 1.000747
#>        beta[iss_stage3] 0.40480051 0.19443604  0.0109766 0.7789988 1.000919
#>  beta[response_cr_vgpr] 0.06115993 0.18544071 -0.3039561 0.4208406 1.001002
#>              beta[male] 0.07802757 0.18034755 -0.2760046 0.4302996 1.000136
#> 
#> Baseline hazard: stratified by study (aux_by = ".study")
#> 
#> Shape / smoothing parameters:
#>         variable      mean        sd      2.5%    97.5%     Rhat
#>  sigma_smooth[1] 0.9868829 0.5000641 0.2544499 2.199313 1.001053
#>  sigma_smooth[2] 1.2380235 0.4790273 0.4704889 2.305084 1.000314
#> 
#> Marginal Treatment Effects:
#>   Log Hazard Ratios (marginal, at t = 1.4):
#>          variable       mean        sd      2.5%     97.5%
#>       delta_index -0.4928694 0.4203785 -1.386022 0.2578401
#>  delta_comparator -0.4899497 0.4176348 -1.380811 0.2536033
#>    (marginal HRs are non-collapsible and vary with time; pass 
#>     `at_time` to marginal_effects() to choose the evaluation time)
#>   RMST Differences (horizon tau = 64.8):
#>              variable     mean       sd      2.5%    97.5%
#>       rmst_diff_index 2.991124 2.407484 -1.538728 7.798941
#>  rmst_diff_comparator 3.831361 2.608200 -1.100997 8.924463
```
...
#>   (package default, mlumr 0.2.0)
#> 
#> Baseline smoothing SD (sigma_smooth, half-distribution via <lower=0>):
#>   normal(0, 1)
#>   (package default, mlumr 0.2.0)
```
...
|:---------------------|:------|:----------|-------:|-------:|---------:|---------:|----------:|---------:|--------:|
|hr_index              |HR     |Index      |     1.4|      NA| 0.6638820| 0.2676340|  0.2500681| 0.6329419| 1.294132|
|hr_comparator         |HR     |Comparator |     1.4|      NA| 0.6650308| 0.2656011|  0.2513747| 0.6350127| 1.288660|
|rmst_diff_index       |RMSTD  |Index      |      NA|    64.8| 2.9911241| 2.4074835| -1.5387282| 2.9595817| 7.798941|
|rmst_diff_comparator  |RMSTD  |Comparator |      NA|    64.8| 3.8313608| 2.6082003| -1.1009968| 3.8240820| 8.924463|
|rmst_ratio_index      |RMSTR  |Index      |      NA|    64.8| 1.0739080| 0.0612046|  0.9655914| 1.0704847| 1.203211|
|rmst_ratio_comparator |RMSTR  |Comparator |      NA|    64.8| 1.1189107| 0.0823980|  0.9674483| 1.1165539| 1.283222|
...
<div class="figure" style="text-align: center">
<img src="figure/loghr-1.png" alt="plot of chunk loghr"  />
...
|:---------|:----------|-------:|--------:|--------:|--------:|--------:|--------:|
|Len       |Index      |    64.8| 44.85818| 1.388786| 42.09044| 44.86533| 47.46556|
|Thal      |Index      |    64.8| 41.86705| 2.014162| 37.78556| 41.93429| 45.62061|
|Len       |Comparator |    64.8| 36.50498| 2.295643| 32.09200| 36.48218| 40.99485|
|Thal      |Comparator |    64.8| 32.67362| 1.261782| 30.23698| 32.67313| 35.09402|
...
|:---------|:----------|--------:|--------:|--------:|--------:|--------:|-------------:|
|Len       |Index      | 53.15793| 3.874376| 45.82666| 53.04619| 60.91522|        0.0000|
|Thal      |Index      | 50.67922| 8.071515| 35.94601| 50.32041| 67.24197|        0.0525|
|Len       |Comparator | 34.86573| 4.300749| 26.93456| 34.71711| 43.59071|        0.0000|
|Thal      |Comparator | 25.80778| 2.353349| 21.41803| 25.74508| 30.72743|        0.0000|
...
<div class="figure" style="text-align: center">
<img src="figure/surv-curves-1.png" alt="plot of chunk surv-curves"  />
...
<div class="figure" style="text-align: center">
<img src="figure/surv-curves-km-1.png" alt="plot of chunk surv-curves-km"  />
...
<div class="figure" style="text-align: center">
<img src="figure/surv-curves-km-2.png" alt="plot of chunk surv-curves-km"  />
<p class="caption">plot of chunk surv-curves-km</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/hazard-curve-1.png" alt="plot of chunk hazard-curve"  />
...
|:--------------------|:------|:----------|-------:|---------:|--------:|---------:|---------:|---------:|
|rmst_diff_index      |RMSTD  |Index      |    64.8| 11.713178| 7.399359| -1.314604| 11.283670| 26.524875|
|rmst_diff_comparator |RMSTD  |Comparator |    64.8|  3.909844| 2.605349| -1.036363|  3.849087|  8.987294|
...
|variable              |effect |population | at_time| horizon|      mean|        sd|       q2.5|       q50|     q97.5|
|:---------------------|:------|:----------|-------:|-------:|---------:|---------:|----------:|---------:|---------:|
|hr_index              |HR     |Index      |     1.4|      NA| 0.4342156| 0.1704325|  0.1913419| 0.4058894| 0.8338899|
|hr_comparator         |HR     |Comparator |     1.4|      NA| 0.4406794| 0.1705096|  0.1956274| 0.4124001| 0.8400192|
|rmst_diff_index       |RMSTD  |Index      |      NA|    64.8| 0.9424052| 2.0633313| -2.9554503| 0.9032894| 5.1939339|
|rmst_diff_comparator  |RMSTD  |Comparator |      NA|    64.8| 1.7447252| 2.2830205| -2.5837389| 1.6843945| 6.3576962|
|rmst_ratio_index      |RMSTR  |Index      |      NA|    64.8| 1.0226480| 0.0476551|  0.9370461| 1.0203540| 1.1264173|
|rmst_ratio_comparator |RMSTR  |Comparator |      NA|    64.8| 1.0540092| 0.0700691|  0.9237469| 1.0509617| 1.1996195|
...
<div class="figure" style="text-align: center">
<img src="figure/weibull-surv-1.png" alt="plot of chunk weibull-surv"  />
...
knitr::kable(data.frame(
  ...
  `RMST (months)` = c(km_rmst(mcc_pbo),
                      mean(summary(m_pbo, newdata = nd, type = "rmst",
...
The transported placebo arm predicts about 30 months of restricted mean survival
for Morgan2012's placebo population, against the roughly 32 months Morgan2012
actually observed. That is close, and it is the reassurance an unanchored
...
extrapolation, and the remaining two-month shortfall is what is left of it after
adjusting for the four measured covariates. Run on the low-overlap Palumbo2014
arm instead, the same check predicts about 19 months against 31 observed.
...
knitr::kable(data.frame(
  ...
  Population = c("comparator", "index", "comparator", "index", "comparator",
...
|:----------------------------------------------------|:--------|:-----------------------|------:|------:|------:|
|Naive Cox (unadjusted)                               |no       |comparator              | -0.554| -0.767| -0.341|
|ML-UMR M-spline (SPFA, prognostic only)              |no       |index                   | -0.493| -1.386|  0.258|
|ML-UMR M-spline (SPFA, prognostic only)              |no       |comparator              | -0.490| -1.381|  0.254|
|ML-UMR M-spline (relaxed, effect modification)       |no       |index                   | -1.051| -2.310|  0.325|
|ML-UMR M-spline (relaxed, effect modification)       |no       |comparator              | -0.490| -1.366|  0.258|
|Anchored: Bucher / fixed-effect NMA                  |yes      |not population-specific | -0.375| -0.677| -0.073|
|Anchored: ML-NMR, prognostic only                    |yes      |not population-specific | -0.357| -0.687| -0.019|
|Anchored: ML-NMR, with * .trt (multinma's own model) |yes      |index                   | -0.840| -1.829|  0.079|
|Anchored: ML-NMR, with * .trt (multinma's own model) |yes      |comparator              | -0.290| -0.760|  0.211|
...
**comparator** population SPFA and relaxed agree almost exactly (-0.490 and
-0.490), and both point the same way as the anchored band while sitting a
little further from the null with much wider intervals. In the **index**
population SPFA is close to its own comparator value (-0.493), but the relaxed
model moves to -1.051, roughly twice as far from the null, with an interval to
match.
...
ML-UMR values above are close (`delta_index` -0.493, `delta_comparator` -0.490),
...
age about 0.10 per year against multinma's 0.08, ISS stage III 0.44 against
0.35, and the response and sex coefficients near zero, where multinma also puts
them. The constancy check misses by about two months.

Neither adjustment produces agreement with the anchored answer. Two conclusions
follow. First, where a common comparator exists it should be used; ML-UMR does
...
* The prognostic coefficients are the part to check first, because they are what
  ...
  from the full five-study network (age about 0.10 per year against 0.08, ISS
  stage III 0.44 against 0.35, response and sex near zero in both).
* **ML-UMR** adjusts for the imbalance and recovers the direction and rough
  magnitude of the anchored answer (SPFA -0.493 in the index population and
  -0.490 in the comparator, against -0.29 to -0.38 anchored), at roughly three
  times the interval width. Read the SPFA and relaxed fits together: they agree
  in the comparator population (-0.490) but diverge in the index population
  (-1.051), which measures how much of the index-population answer rests on
