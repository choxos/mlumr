...
#include "stanExports_mlumr_survival_spfa.h"

RCPP_MODULE(stan_fit4mlumr_survival_spfa_mod) {


    class_<rstan::stan_fit<stan_model, stan::rng_t> >("rstantools_model_mlumr_survival_spfa")
