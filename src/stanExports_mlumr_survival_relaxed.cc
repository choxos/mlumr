...
#include "stanExports_mlumr_survival_relaxed.h"

RCPP_MODULE(stan_fit4mlumr_survival_relaxed_mod) {


    class_<rstan::stan_fit<stan_model, stan::rng_t> >("rstantools_model_mlumr_survival_relaxed")
