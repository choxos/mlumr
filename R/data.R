...
#'   causal truth: the synthesis reproduces the covariate and
#'   covariate-outcome relationships of the source trial, which does not define
#'   a population causal effect that could be computed and compared against.
#'   Because the label
