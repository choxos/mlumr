...
#'
#' Mirrors Stan's `log_gamma_surv_from_log_x()`. Below a `log_x` of -700 the
#' leading series term `w^k / gamma(k + 1)` is exact, where `exp(log_x)`
#' would underflow and `pgamma(0, k)` report survival 1. Every R site needing
