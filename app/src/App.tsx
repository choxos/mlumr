...
// "How it works" workflow step cards. Shared by the tabbed page and the
// one-page info band.
function HowSteps() {
  return (
    <div className="info-grid">
      <InfoItem badge="1" title="Define the comparison" body="Choose the outcome family, the SPFA or relaxed model, and the link function used by the Stan likelihood." />
      <InfoItem badge="2" title="Prepare browser data" body="CSV inputs are standardized into an mlumr-like object, then comparator covariate distributions are converted into numerical integration points." />
      <InfoItem badge="3" title="Run precompiled Stan" body="The app loads the matching TinyStan WebAssembly bundle and samples locally in the browser worker." />
      <InfoItem badge="4" title="Inspect outputs" body="Generated quantities from the mlumr Stan model are summarized for treatment effects and population-average predictions." />
    </div>
  );
}
...
function MethodologyProse() {
  return (
    <div className="prose-columns">
      <p>
        ML-UMR combines individual patient data for an index treatment with aggregate data for a comparator treatment. The browser app mirrors the package contract for binary, continuous, and count outcomes: IPD contributes individual likelihood terms, while AgD contributes arm-level summaries after marginalizing over the comparator covariate distribution.
      </p>
      <p>
      ...
      <p>
        Comparator-population integration uses deterministic low-discrepancy points with a Gaussian copula correlation adjustment. Normal and Bernoulli covariate margins are supported in this first browser build.
      </p>
    </div>
  );
}
...
function AboutContent() {
  return (
    <>
      <div className="prose-columns">
        <p>
          mlumr Playground is a local, self-contained companion to the mlumr R package. Everything runs in your browser: no data leaves your machine, and no server or local R installation is required.
        </p>
        <p>
          The Stan models are precompiled to WebAssembly with TinyStan and sampled in a background worker, so the workflow mirrors the R package without an R runtime. That keeps the tool easy to share and suitable for sensitive patient data.
        </p>
        <p>
          This build covers binary, continuous, count, and time-to-event outcomes under the SPFA and relaxed specifications, including parametric and flexible-baseline survival variants. The browser workflow can also run SPFA and relaxed fits sequentially for side-by-side comparison.
        </p>
      </div>
      ...
      <div className="refs">
        ...
        <ul>
          <li><a href="https://choxos.github.io/mlumr" target="_blank" rel="noreferrer">mlumr package documentation</a></li>
          <li>Browser sampling backend: <a href="https://github.com/flatironinstitute/stan-playground" target="_blank" rel="noreferrer">Stan Playground</a> and <a href="https://github.com/WardBrian/tinystan" target="_blank" rel="noreferrer">TinyStan</a> (WebAssembly builds of Stan).</li>
          <li>Ward B, Soules J, Magland J. stan-playground: Run Stan models directly in your browser. <em>Journal of Open Source Software</em>. 2026;11(118):9531. <a href="https://doi.org/10.21105/joss.09531" target="_blank" rel="noreferrer">doi:10.21105/joss.09531</a></li>
          <li>Ward B. tinystan: Easy, minimal interface to the Stan samplers in several languages. GitHub; 2025. <a href="https://github.com/WardBrian/tinystan" target="_blank" rel="noreferrer">github.com/WardBrian/tinystan</a></li>
          <li><a href="https://github.com/choxos/mlumr" target="_blank" rel="noreferrer">mlumr source code on GitHub</a></li>
          <li><a href="https://www.valueinhealthjournal.com/article/S1098-3015(25)05944-3/abstract" target="_blank" rel="noreferrer">Chandler C, Ishak KJ. Anchors away: navigating unanchored indirect comparisons with multilevel unanchored meta-regression. ISPOR Europe 2025, Glasgow, UK (poster MSR28).</a></li>
          <li><a href="https://www.ispor.org/heor-resources/presentations-database/presentation-cti/ispor-2026/poster-session-3-3/surviving-unanchored-indirect-comparisons-an-extension-of-multilevel-unanchored-meta-regression-ml-umr-for-survival-analyses" target="_blank" rel="noreferrer">Chandler C, Ishak KJ. Surviving unanchored indirect comparisons: an extension of multilevel unanchored meta-regression (ML-UMR) for survival analyses. ISPOR 2026, Philadelphia, PA, USA (poster MSR131; Value in Health).</a></li>
        </ul>
      </div>
    </>
  );
...
function InfoItem({ badge, title, body }: { badge: string; title: string; body: string }) {
  return (
